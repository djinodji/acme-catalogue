package com.acme.catalogue.utils;
...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float cxe = (mSnap ? mSnapPage : mCurrentPage) * threeRadius;
        if ((longOffset + cxe<0))
        {
            longOffset=-cxe-mCurrentPage+10;
        }

        if ((longOffset + cxe>width))
        {
            longOffset=width-cxe-mCurrentPage;
        }
